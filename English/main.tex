...
\begin{document}
    ...
    \begin{paracol}{2}
        % ----- Competências -----
        \input{English/tex/technologies_proficient}

        \input{English/tex/technologies_familiar}
        % ----- Competências -----
        ...
        \input{English/tex/education_curses}

        \input{English/tex/experience}

        \input{English/tex/academic_backgroud}

        \input{English/tex/certifications}

        \input{English/tex/certificates}

        \input{English/tex/featured_projects}

        \input{English/tex/projects_webtech}
        
        \input{English/tex/projects_puctec}
        
        \input{English/tex/projects_college}

...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Education and Courses}
            \begin{quote}
                I study Computer Science at Pontifical Catholic University of Minas Gerais, currently in the 6th period. Interested in Back-End Development, DevOps, and Cloud Computing.
            \end{quote}
        % ----- ABOUT ME -----
        ...
        \cvevent{Kotlin Language Course - Alura}{\cvreference{\faGlobe}

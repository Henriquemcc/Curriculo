...
certificados.append(Certificate(name="Kotlin and Spring: Security and Infrastructure", url="https://cursos.alura.com.br/certificate/d8f74354-d9e0-4116-87b3-68b7c510620c?lang", github="https://github.com/Henriquemcc/Forum_-_Formacao_Kotlin_e_Spring_Boot_-_Alura", location=online, date=datetime.date(2025, 1, 14)))

# Kotlin e Spring: testes automatizados e documentação de API
certificados.append(Certificate(name="Kotlin and Spring: Automated Testing and API Documentation", url="https://cursos.alura.com.br/certificate/ec4e4ab1-b0a9-4db6-b6af-cb6e349fbcb2?lang", github="https://github.com/Henriquemcc/Forum_-_Formacao_Kotlin_e_Spring_Boot_-_Alura", date=datetime.date(2025, 1, 26), location=online))
...
certificados.append(Certificate(name="REST API with Kotlin and Spring Boot: Web Layer - Alura", url="https://cursos.alura.com.br/certificate/d42563e9-0604-4603-84d4-225f3addfa3b?lang", github="https://github.com/Henriquemcc/Forum_-_Formacao_Kotlin_e_Spring_Boot_-_Alura", date=datetime.date(2024, 9, 12), location=online))

# API REST com Kotlin e Spring Boot: Camada de persistência - Alura
certificados.append(Certificate(name="REST API with Kotlin and Spring Boot: Persistence Layer - Alura", url="https://cursos.alura.com.br/certificate/739b9d7c-301b-4065-ab63-6d60a67424b9?lang", github="https://github.com/Henriquemcc/Forum_-_Formacao_Kotlin_e_Spring_Boot_-_Alura", date=datetime.date(2024, 9, 26), location=online))

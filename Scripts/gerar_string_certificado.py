...
certificados.append(Certificate(name="API REST com Kotlin e Spring Boot: Camada Web - Alura", url="https://cursos.alura.com.br/certificate/d42563e9-0604-4603-84d4-225f3addfa3b?lang", date=datetime.date(2024, 9, 12), location=online))

# API REST com Kotlin e Spring Boot: Camada de persistência - Alura
certificados.append(Certificate(name="API REST com Kotlin e Spring Boot: Camada de persistência - Alura", url="https://cursos.alura.com.br/certificate/739b9d7c-301b-4065-ab63-6d60a67424b9?lang", date=datetime.date(2024, 9, 26), location=online))
...
certificados.append(Certificate(name="Formação Linguagem Kotlin - Alura", url="https://cursos.alura.com.br/degree/certificate/18f608ec-a511-43b4-8586-04c87b079a4c?lang", date=datetime.date(2021, 7, 7), location=online))

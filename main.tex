...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Experiência}
            ...
            \cvevent{Monitor de Ciência da Computação}{Pontifícia Universidade Católica de Minas Gerais}{08 2023 --}{Belo Horizonte, Minas Gerais, Brasil}
            % \divider
        % ----- Experiência -----
...
}{02 2018 -- 12 2026}{Belo Horizonte, Minas Gerais, Brasil}
            % \divider
        % ----- Formação acadêmica -----
        ...
        \cvevent{Fluência em Inglês - Cambridge - B2 First – Score 172}{
        ...
        \cvevent{Fluência em Inglês - Cambridge - B2 First – Score 166}{

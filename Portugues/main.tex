...
\begin{document}
    ...
    \begin{paracol}{2}
        % ----- Competências -----
        \input{Portugues/tex/tecnologias_domino}

        \input{Portugues/tex/tecnologias_familiarizado}
        % ----- Competências -----
        ...
        \input{Portugues/tex/cursos_escolaridade}
        
        \input{Portugues/tex/experiencia}
        
        \input{Portugues/tex/formacao_academica}
        
        \input{Portugues/tex/certificacoes}

        \input{Portugues/tex/certificados_destaque}

        \input{Portugues/tex/certificados}

        \input{Portugues/tex/projetos_destaque}
        
        \input{Portugues/tex/projetos_webtech}

        \input{Portugues/tex/projetos_puctec}

        \input{Portugues/tex/projetos_faculdade}

...
\begin{document}
    ...
    \begin{paracol}{2}
        ...
        \cvsection{Sobre Mim}
            \begin{quote}
                Estudo Ciência da Computação na Pontifícia Universidade Católica de Minas Gerais.
            \end{quote}
        % ----- ABOUT ME -----
...
}{02 2018 -- 12 2025}{Belo Horizonte, Minas Gerais, Brasil}
            % \divider
        % ----- Formação acadêmica -----
        ...
        \cvevent{Certificado de Participação: AWS Cloud Practitioner Essentials}{
        \cvreference{\faGlobe}
        {https://drive.google.com/file/d/12NtAd2mEhy8O61W-jrLhG-oAnrUvBNqx/view?usp=drive_link}
        }{01-2024}{Online}
        \divider
        
        \cvevent{Cursos da Alura}{
        ...
        \cvevent{Fluência em Inglês - B2 First – Score 172 - Cambridge University Press \& Assessment English}{
        \cvreference{\faGlobe}{https://drive.google.com/file/d/1XlpfYXp5Veeiyn8zAHABk8SSAO36QncZ/view?usp=sharing}
        }{09-2022}{Belo Horizonte, Minas Gerais, Brasil}
        \divider

        \cvevent{Fluência em Inglês - B2 First – Score 166 - Cambridge University Press \& Assessment English}{
        \cvreference{\faGlobe}{https://drive.google.com/file/d/1_a7pPVYLn72of6atRhqDsAnVPhztZAF9/view?usp=sharing}
        }{02-2019}{Belo Horizonte, Minas Gerais, Brasil}
        \divider
